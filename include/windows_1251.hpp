...
namespace worms_server {
    ...
    public:
        ...
        static std::string encode(const std::string_view utf8_input) {
            ...
            for (size_t i = 0; i < utf8_input.length();) {
                ...
                i += len;
                result.push_back(static_cast<char>(unicode_to_windows1251(codepoint)));
            }
        ...
        static std::optional<std::string> encode_strict(const std::string_view utf8_input) {
            std::string result;
            result.reserve(utf8_input.size());
        ...
        static std::string decode(const std::string& win1251_input) {
            std::string result;
            result.reserve(win1251_input.size() * 2); // UTF-8 may need more space
    ...
    private:
        ...
        static size_t utf8_to_codepoint(const std::string_view input, const size_t pos, uint32_t& codepoint) {
