...
namespace worms_server
{
	...
	{
		unknown = 0, list_rooms = 200, list_item = 350, list_end = 351, list_users = 400, list_games = 500, login = 600,
		login_reply = 601, create_room = 700, create_room_reply = 701, join = 800, join_reply = 801, leave = 900,
		leave_reply = 901, disconnect_user = 1000, close = 1100, close_reply = 1101, create_game = 1200,
		create_game_reply = 1201, chat_room = 1300, chat_room_reply = 1301, connect_game = 1326,
