...
namespace worms_server
{
    ...
    worms_packet::read_from(net::packet_reader& reader)
    {
    ...
    void worms_packet::write_to(net::packet_writer& writer) const
    {
        ...
        if (fields_.name)
        {
            ...
            const auto length =
                std::min(encoded_bytes.size_bytes(), max_name_length);
    ...
    packet_code worms_packet::code() const { return code_; }
    ...
    const packet_fields& worms_packet::fields() const { return fields_; }
